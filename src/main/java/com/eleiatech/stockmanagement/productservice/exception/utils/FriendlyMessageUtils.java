...
import com.eleiatech.stockmanagement.productservice.exception.enums.IFrendlyMessageCode;
...
@Slf4j
@UtilityClass //classtaki bütün metodların static işaretlenmesini saglar
public class FriendlyMessageUtils {

    private static  final String RESOURCE_BUNDLE_NAME= "FriendlyMessage"; //mesajları iceren kaynak dosyanın adını temsil eder
    private static final String SPECIAL_CHARACTER="__";

    public static String getFriendlyMessage(Language language, IFrendlyMessageCode messageCode){
